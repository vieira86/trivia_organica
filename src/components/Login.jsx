...
const STEPS = [
  ...
  { icon: '🧪', title: 'Responda', desc: 'Perguntas de todas as áreas da Química' },
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center pt-2 pb-16">
          <div className="animate-fade-in-up text-center lg:text-left">
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-xl mx-auto lg:mx-0">
              Um tabuleiro com perguntas de todas as áreas da Química — Geral, Inorgânica,
              Analítica, Físico-Química, Orgânica e Bioquímica. Jogue no mesmo aparelho ou
              online, cada um na sua casa.
            </p>

            <div className="mt-6 flex flex-wrap gap-3 justify-center lg:justify-start">
              <span className="stat-chip">🎲 2 a 4 jogadores</span>
              <span className="stat-chip">🧪 6 áreas da Química</span>
              <span className="stat-chip">🌐 Modo online</span>
              <span className="stat-chip">☢️ Casas-armadilha</span>
        ...
        <div className="glass-morphism rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-8 p-4 bg-blue-50 dark:bg-slate-800/60 rounded-lg border border-blue-200 dark:border-slate-700">
            ...
            <ul className="text-sm text-blue-700 dark:text-blue-200 space-y-1">
              ...
              <li>• Cuidado com as casas-armadilha — elas mudam a cada partida!</li>
